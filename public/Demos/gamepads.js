...
function ReadGamepadState() {
    ...
    drawObjs[1].setAxis(0, gamepads[0].axes[2]);
    drawObjs[1].setAxis(1, gamepads[0].axes[3]);
    drawObjs[2].setPressed(gamepads[0].buttons[0].pressed, "gamepad");
    drawObjs[3].setPressed(gamepads[0].buttons[1].pressed, "gamepad");
}
